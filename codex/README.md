...
По умолчанию удаляются установленный плагин, его остаточный кэш Codex,
регистрация локального marketplace и сгенерированный `node_modules`. Исходники
репозитория и выбранный путь браузера сохраняются. Дополнительные режимы:
